    ...
    def dyno_update(self):
        ...
        if self.y_speed > 0:
            ...
            for p in platforms_touched:
                self.y_speed = 2
    def fire(self):
        acorn = Player(15,15,(self.rect.x + 37.5),(self.rect.y + 37.5),'sword.png',0,0)
        acorns.add(acorn)
        acorn.draw_pic()
        if self.x_speed > 0:
            acorn.x_speed = 6
...
#ЗМІННІ
img =  transform.scale(image.load('Castle.jpg'),(700,500))
...
final = GameSprite(80,60,620,10,'portal.png')
lose = transform.scale(image.load('die.png'),(700,500))
...
dynos = sprite.Group()
acorns = sprite.Group()
boar = Player(75,75,0,425,'Knight.png',0,0)
dyno = Player(55,55,615,240,'skeleton.png',0,0)
dyno2 = Player(55,55,500,100,'skeleton.png',0,0)
dynos.add(dyno)
dynos.add(dyno2)
acorn = Player(15,15,(boar.rect.x + 37.5),(boar.rect.y + 37.5),'pulia.png',0,0)
dyno.y_speed = 2
dyno2.y_speed = -2
